...
object Analysis {
  def wordAnalysis(msg: String, storedTime: String) = {
    ...
    val strJson = new StringBuilder("{\"documentID\":\"" + storedTime + "\", \"from\": \"Justin\", \"To\": \"Cybang\", \"Time\": \"2019-09-30 오전 6:41:28\", \"Text\": [")
